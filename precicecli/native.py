...
def makeCheckParser(_):
    ...
    parser.add_argument("-d", "--debug", action="store_true", help="Enable debug output in the configuration checker.")
...
def runCheck(ns):
    ...
    try:
        ...
        print("precice-config-validate wasn't found, hence the validation will be skipped. This may lead to crashes in the configuration checker.", file=sys.stderr)
        print("Please install preCICE and add it to your PATH for best results.", file=sys.stderr)
